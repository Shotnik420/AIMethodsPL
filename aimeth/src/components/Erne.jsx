...
import dron1 from "../img/erne/dron1.jpg";
import dron2 from "../img/erne/dron2.jpg";
import dron3 from "../img/erne/dron3.jpg";
import dron4 from "../img/erne/dron4.jpg";
import dron5 from "../img/erne/dron5.jpg";
import dron6 from "../img/erne/dron6.jpg";
import dron7 from "../img/erne/dron7.jpg";
import dron8 from "../img/erne/dron8.jpg";
import dron9 from "../img/erne/dron9.jpg";
import dron10 from "../img/erne/dron10.jpg";
import dron11 from "../img/erne/dron11.jpg";
  ...
  return (
    ...
    >
      ...
      >
        <div
          style={{
            backgroundImage: `url(${dron1})`,
            backgroundPosition: "0% 50%",
          }}
          className="page"
        >
          <h1>
            {/* <span>SILESIAN ERNE</span> */}{" "}
            <span>
              <strong>SILESIAN ERNE</strong>
            </span>
          </h1>
        </div>
        <div
          style={{
            backgroundImage: `url(${dron2})`,
