        ...
        <div className="silesianText--2">
            <div className="silesianText--2--LineContainer">
              ...
              <div className="silesianText--2--Text">
                  Cala powloka <b className="white">Silesian </b><b className="orange">Phoenix</b> jest zrobiona z bardzo lekkiego oraz bardzo wytrzymalego materialu jakim jest <b className="white">wlokno weglowe</b>. Dzieki zastosowaniu tego materialu lazik wazy zaledwie <b className="orange">[] kg </b> i jest zdecydowanie bardziej zwinny i latwiejszy w kontrolii od konkurencji.
              </div>
            </div>
        </div>
        <div className="silesianText--3">
          <p>Lazik <b className="white">Silesian </b><b className="orange">Phoenix </b>jest odporne na pył, pot i wodę (klasa ochrony IP54)<sub>10</sub>.</p>
        </div>
      </div>
      <Parallax
